...
public class EveningAdapter extends RecyclerView.Adapter<EveningAdapter.ViewHoler> {

    AllFragment context;
    int layout;
    ArrayList<Location> arrayList;

    public EveningAdapter(AllFragment context, int layout, ArrayList<Location> arrayList) {
    ...
    @NonNull
    @Override
    public EveningAdapter.ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context.getActivity()).inflate(layout, parent, false);
        return new ViewHoler(v);
    }

    @Override
    public void onBindViewHolder(@NonNull EveningAdapter.ViewHoler holder, int position) {
