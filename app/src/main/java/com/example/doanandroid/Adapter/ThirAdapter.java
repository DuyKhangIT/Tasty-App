...
public class ThirAdapter extends RecyclerView.Adapter<ThirAdapter.ViewHoler> {

    ThirFragment context;
    int layout;
    ArrayList<Location> arrayList;

    public ThirAdapter(ThirFragment context, int layout, ArrayList<Location> arrayList) {
    ...
    @NonNull
    @Override
    public ThirAdapter.ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context.getActivity()).inflate(layout, parent, false);
        return new ViewHoler(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ThirAdapter.ViewHoler holder, int position) {
