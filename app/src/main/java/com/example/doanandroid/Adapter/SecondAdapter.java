...
public class SecondAdapter extends RecyclerView.Adapter<SecondAdapter.ViewHoler> {

    SecondFragment context;
    int layout;
    ArrayList<Location> arrayList;

    public SecondAdapter(SecondFragment context, int layout, ArrayList<Location> arrayList) {
    ...
    @NonNull
    @Override
    public SecondAdapter.ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context.getActivity()).inflate(layout, parent, false);
        return new ViewHoler(v);
    }

    @Override
    public void onBindViewHolder(@NonNull SecondAdapter.ViewHoler holder, int position) {
