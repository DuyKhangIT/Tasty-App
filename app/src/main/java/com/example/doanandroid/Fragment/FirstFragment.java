...
import com.example.doanandroid.Adapter.LocationAdapter;
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                            ...
                            if(documentSnapshot.getString("timeInDay").toString().equals("morning")){
                        ...
                        for(int i=listTittles.size()-1;i>=0;i--){ //duyet nguoc mang
                        ...
                        locationAdapter = new LocationAdapter(FirstFragment.this, R.layout.item_location, locationArrayList);
                        lvData.setAdapter(locationAdapter);
