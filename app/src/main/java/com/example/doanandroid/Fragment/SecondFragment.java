...
import com.example.doanandroid.Adapter.SecondAdapter;
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                if(documentSnapshot.getString("timeInDay").toString().equals("evening")){
                            ...
                            adapter = new SecondAdapter(SecondFragment.this, R.layout.item_location, locationArrayList);
