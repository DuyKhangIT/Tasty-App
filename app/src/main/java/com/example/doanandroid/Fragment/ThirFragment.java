...
import com.example.doanandroid.Adapter.ThirAdapter;
 ...
 * Use the {@link ThirFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ThirFragment extends Fragment implements AdapterView.OnItemClickListener {
     ...
     * @return A new instance of fragment ThirFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ThirFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_thir, container, false);
        return v;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView lvData = v.findViewById(R.id.lvData);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                if(documentSnapshot.getString("timeInDay").toString().equals("noon")){
                            ...
                            int[] imgUser = {R.drawable.u1, R.drawable.u2, R.drawable.u3,};
                            ...
                            ThirAdapter adapter;
                            adapter = new ThirAdapter(ThirFragment.this, R.layout.item_location, locationArrayList);
